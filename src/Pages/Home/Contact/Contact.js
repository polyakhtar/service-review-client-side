    ...
    return (
        ...
        <div className="container px-6 py-12 mx-auto">
          <div className="text-center">
            ...
            <h1 className="mt-2 text-2xl font-semibold text-orange-600 md:text-3xl dark:text-white">Get in touch</h1>
          ...
          <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="mt-2 text-blue-500 dark:text-blue-400">poly.akhtar24@gmail.com</p>
            </div>
            <div className="flex flex-col items-center justify-center text-center">
              <span className="p-3 text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
              ...
              <p className="mt-2 text-blue-500 dark:text-blue-400">Cumilla, Bangladesh</p>
            </div>
            <div className="flex flex-col items-center justify-center text-center">
              <span className="p-3 text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
              ...
              <p className="mt-2 text-blue-500 dark:text-blue-400">+8801865164256</p>
            </div>
          </div>
        </div>
      </section>
